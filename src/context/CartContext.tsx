    ...
    setItems((prevItems) => {
      ...
      if (existingIndex > -1) {
        ...
        const newItem: CartItem = {
          ...
          uploadedPhotos: (product as any).uploadedPhotos || product.images,
          customCaption: (product as any).customCaption,
          customCaptions: (product as any).customCaptions,
          songUrl: (product as any).songUrl,
          songUrls: (product as any).songUrls,
          giftNote: (product as any).giftNote,
          wrappingStyle: (product as any).wrappingStyle,
          ribbonColor: (product as any).ribbonColor,
          fairyLights: (product as any).fairyLights,
