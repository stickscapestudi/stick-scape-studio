...
export const OrderConfirmationPage: React.FC = () => {
  ...
  const order = lastOrder || {
    ...
    items: [
      ...
      {
        cartItemId: 'prod-03_pack-32_finish-classic-white',
        id: 'prod-03',
        name: 'Unnale Unnale — 32 Pack Retro Polaroids',
        category: 'polaroids' as const,
        basePrice: 120.00,
        unitPrice: 250.00,
        image: '/unnale unnale.jpeg',
        selectedSize: { id: 'pack-32', name: 'Pack of 32 (32 Prints + Clips)', dimensions: '8.8 × 10.7 cm', priceMultiplier: 250 / 120, inStock: true },
        quantity: 1,
      }
    ],
    subtotal: 648.00,
