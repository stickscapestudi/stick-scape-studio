...
export const POSTER_SIZES: ProductSize[] = [
  ...
  { id: 'size-a3', name: 'A3 Standard Studio Print', dimensions: '29.7 × 42.0 cm (11.7 × 16.5 in)', priceMultiplier: 1.1, inStock: true },
  { id: 'size-a2', name: 'A2 Statement Wall Art', dimensions: '42.0 × 59.4 cm (16.5 × 23.4 in)', priceMultiplier: 1.2, inStock: true },
  { id: 'size-a1', name: 'A1 Exhibition Scale Poster', dimensions: '59.4 × 84.1 cm (23.4 × 33.1 in)', priceMultiplier: 1.3, inStock: true },
];

/* ✏️ SIZES FOR POLAROID PACKS */
export const POLAROID_PACK_SIZES: ProductSize[] = [
  { id: 'pack-12', name: 'Mini Pack (12 Photo Prints)', dimensions: '8.8 × 10.7 cm (Classic 3.5 × 4.2 in)', priceMultiplier: 1.0, inStock: true },
  { id: 'pack-24', name: 'Collector Pack (24 Prints + Wooden Clips & Twine)', dimensions: '8.8 × 10.7 cm (Classic 3.5 × 4.2 in)', priceMultiplier: 1.5, inStock: true },
  { id: 'pack-48', name: 'Studio Mega Box (48 Prints + Fairy Lights & Clips)', dimensions: '8.8 × 10.7 cm (Classic 3.5 × 4.2 in)', priceMultiplier: 2.2, inStock: true },
];
...
export const SAMPLE_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    tags: ['Best Value', 'Save 38%', 'Full Kit', 'Gift Favorite'],
